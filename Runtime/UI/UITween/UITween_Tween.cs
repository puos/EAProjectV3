...
[System.Serializable]
public class UITween_Tween
{
	[HideInInspector][SerializeField]UITween_TweenType _tweenType = UITween_TweenType.PositionTween;
    ...
    //BezierCurve
    [HideInInspector] [SerializeField] UITween_BezierCurve _bezierCurve;
    ...
    public void Init (Transform transObj)
	{
        ...
        switch (_tweenType)
        {
            case UITween_TweenType.PositionTween:
                break;

            case UITween_TweenType.RotateTween:
                break;

            case UITween_TweenType.ScaleTween:
                break;

            case UITween_TweenType.ColorTween:
            case UITween_TweenType.AlphaTween:
                if (_tweenObject != null)
                {
					...
					canvasGroup = _tweenObject.GetComponent<CanvasGroup>();
				}
                break;

            case UITween_TweenType.FieldOfViewTween:
                tweenCamera = _tweenObject.GetComponent<Camera>();
                break;

            case UITween_TweenType.BezierCurve:
                break;
        }
	}
	...
	public void PlayAtTime (float curveValue)
	{
		...
		switch (_tweenType)
		{
			case UITween_TweenType.PositionTween:
				if (_isLocal)
				{
					RectTransform rt = _tweenObject.GetComponent<RectTransform>();
					rt.anchoredPosition = (toVector - fromVector) * curveValue + fromVector;
				}
				else
