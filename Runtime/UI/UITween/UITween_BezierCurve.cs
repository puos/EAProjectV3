...
public class UITween_BezierCurve : MonoBehaviour 
{

    [HideInInspector][SerializeField] List<UITween_BezierPoint> m_bezierPoints = new List<UITween_BezierPoint>();
    ...
    public void AddPoint ()
    {
        ...
        UITween_BezierPoint newPoint = newObj.AddComponent<UITween_BezierPoint>();
    ...
    public UITween_BezierPoint GetPoint (int index)
    {
        if (index < pointCount)
    ...
    public Vector3 GetPointInCurve (float timeValue)
    {
        ...
        {
            UITween_BezierPoint thisPoint = GetPoint(i);
            UITween_BezierPoint nextPoint = GetPoint(i + 1);
	...
	public UITween_BezierPoint GetPrePoint (int index)
	{
		int i = index - 1;
		if (isClose && i < 0)
		{
	...
	public UITween_BezierPoint GetNextPoint (int index)
	{
		int i = index + 1;
    ...
    Vector3 GetPoint (UITween_BezierPoint point01, UITween_BezierPoint point02,float t)
    {
        ...
        return UITween_BezierCurveTools.GetBezierCurvePoint(p1, p2, p3, p4, t);
    }

    float GetCurveLenght (UITween_BezierPoint point01,UITween_BezierPoint point02)
    {
        if (point01 == null || point02 == null)
            return 0;
        ...
        for (int j = 0; j <= sample; j++)
        {
            ...
            Vector3 thisPos = UITween_BezierCurveTools.GetBezierCurvePoint(p1, p2, p3, p4, t);
