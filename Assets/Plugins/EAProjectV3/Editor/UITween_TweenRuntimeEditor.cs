...
[CustomEditor (typeof (UITween_TweenRuntime))]
public class UITween_TweenRuntimeEditor : Editor 
{
	Vector2 tweenListPos;
	UITween_TweenType addTweenType = UITween_TweenType.PositionTween;
	...
	public override void OnInspectorGUI ()
	{
		...
		UITween_TweenRuntime tar = (UITween_TweenRuntime)target;
		...
		GUILayout.BeginHorizontal ();
		addTweenType = (UITween_TweenType)EditorGUILayout.EnumPopup (addTweenType);
                        ...
                        case 6:
                            ...
                            if(bezierCurve.objectReferenceValue == null)
                            {
                                if(GUILayout.Button("Create",EditorStyles.miniButton,GUILayout.Width(60)))
                                {
                                    ...
                                    bezierCurve.objectReferenceValue = newObj.AddComponent<UITween_BezierCurve>();
	...
	void SetCurrentValueToTween (SerializedProperty thisTween,bool isFromValue)
	{
		...
		if(tweenObject.objectReferenceValue != null)
		{
			...
			RectTransform rt = tweenObj.GetComponent<RectTransform>();
			switch (type.enumValueIndex)
			{
				case 0:
					vectorValue = isLocal.boolValue ? new Vector3(rt.anchoredPosition.x, rt.anchoredPosition.y) : rt.position;
					break;
